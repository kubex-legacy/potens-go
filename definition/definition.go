...
//App Types
const (
	// AppTypePlatformService Standard Service - Non UI
	AppTypePlatformService AppType = "kubex.platform.service"

	// AppTypePlatformModule Module - UI for integrations, but no app shell iteself
	AppTypePlatformModule AppType = "kubex.platform.module"

	// AppTypePlatformApplication Standard Application
	AppTypePlatformApplication AppType = "kubex.platform.application"
)
