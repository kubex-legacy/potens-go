...
import (
	...
	pauth "github.com/kubex/potens-go/auth"
...
func (d *AppDefinition) IsPermitted(auth pauth.UserData, roles, permissions []AppScope) bool {
	...
	if auth.HasRole(string(pauth.RoleProjectOwner)) {
		return true
	}
